export const DEPARTMENTS = [
  ...
  { code: 'CD', name: 'Corps Diplomatique', region: 'Spécial' },
  { code: 'W', name: 'Transit / Garage', region: 'Spécial' },
  { code: 'TT', name: 'Transit Temporaire', region: 'Spécial' },
]

export const DEPARTMENTS_BY_CODE = Object.fromEntries(DEPARTMENTS.map(d => [d.code, d]))

export const REGIONS = [...new Set(DEPARTMENTS.map(d => d.region))]

export const DEPARTMENTS_BY_REGION = REGIONS.reduce((acc, region) => {
  acc[region] = DEPARTMENTS.filter(d => d.region === region)
  return acc
}, {})
